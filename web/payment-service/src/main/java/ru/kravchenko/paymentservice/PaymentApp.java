 ...
 * - Добавить возможность запрашивать продукты у платежного сервиса (клиент кидает запрос в платежный сервис,
 ...
 * - В запросах к платежному сервису идентификатором пользователя является заголовок USERID (самих пользователей пока
 * нигде не храним)
 */
